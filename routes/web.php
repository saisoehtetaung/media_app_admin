...
Route::middleware([
    ...
    Route::get('admin/changePassword',[ProfileController::class,'directChangePassword'])->name('admin#changePasswordPage');
    ...
    Route::get('category/delete/{id}',[CategoryController::class,'deleteCaregory'])->name('admin#deleteCategory');
